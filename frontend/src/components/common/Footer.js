		...
		<div className="bg-richblack-800">
			<div className="flex flex-col  text-white w-11/12 max-w-maxContent mx-auto pt-14">
					...
					<div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
						<div className="w-[48%] lg:w-[30%] flex flex-col gap-3 ">
							...
							<div className="flex gap-3 text-lg text-richblack-400 -mt-5">
								<Link to={"https://www.linkedin.com/in/anikr29/"}>
									<FaLinkedin />
								</Link>
								<Link to={"https://twitter.com/Eternatus29"}>
									<FaTwitter />
								</Link>
								...
								<Link
									to={
										"https://www.facebook.com/profile.php?id=100004320345354&mibextid=ZbWKwL"
									}
								>
									<FaFacebook />
								</Link>
								<Link to={"https://www.instagram.com/anik._.roy/"}>
									<FaInstagram />
								</Link>
							</div>
						</div>
				...
				<div className="flex flex-col lg:flex-row justify-between items-center text-richblack-400 text-sm py-14">
					...
					<div className="text-center">&copy; SkillCraft 2024</div>
				</div>
			</div>
		</div>
	);
